...
public class GeneralEntityServiceContextHolder {
     ...
     * @param recordId
     */
    public static void setAllowForceUpdateOnce(ID recordId) {
     ...
     * @param clear
     * @return
     * @see #setAllowForceUpdateOnce(ID)
     */
    public static boolean isAllowForceUpdateOnce(boolean clear) {
        ID recordId = ALLOW_FORCE_UPDATE.get();
        if (recordId != null && clear) {
