...
public enum DisplayType {
    ...
    NTEXT(EasyNText.class, "多行文本", FieldType.TEXT, 65535, null),
    EMAIL(EasyEmail.class, "邮箱", FieldType.STRING, 100, null),
    URL(EasyUrl.class, "链接", FieldType.STRING, 300, null),
    PHONE(EasyPhone.class, "电话", FieldType.STRING, 50, null),
    SERIES(EasySeries.class, "自动编号", FieldType.STRING, 50, "{YYYYMMDD}-{0000}"),
    ...
    LOCATION(EasyLocation.class, "位置", FieldType.STRING, 300, null),
    SIGN(EasySign.class, "签名", FieldType.TEXT, 65535, null, false, true),
    TAG(EasyTag.class, "标签", FieldType.STRING, 50, null),
