...
import static com.rebuild.core.support.i18n.I18nUtils.formatDate;
...
public class CommonsConfigController extends BaseController {
    ...
    public RespBody list(HttpServletRequest request) {
        ...
        String sql = "select configId,name,config,modifiedOn,createdOn,belongEntity from CommonsConfig where type=?";
        ...
        for (Object[] o : array) {
            String be = (String) o[5];
            String beLabel = be;
            if (be != null && MetadataHelper.containsEntity(be)) {
                beLabel = Language.L(MetadataHelper.getEntity(be));
            }

            JSONObject item = JSONUtils.toJSONObject(
                    new String[]{"id", "name", "modifiedOn", "createdOn", "entity"},
                    new Object[]{o[0], o[1], formatDate((Date) o[3]), formatDate((Date) o[4]), new String[]{be, beLabel}});
