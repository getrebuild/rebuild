 ...
 * @see RecentlyUsedSearchControl
 * @since 08/24/2018
 */
@Controller
@RequestMapping("/commons/search/")
public class ReferenceSearchControl extends EntityController {
    ...
    public void referenceSearch(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (StringUtils.isBlank(q)) {
            ...
            if (recently == null || recently.length == 0) {
                ...
                writeSuccess(response, RecentlyUsedSearchControl.formatSelect2(recently, null));
            }
            return;
        }
