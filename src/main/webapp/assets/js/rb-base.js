...
(function ($) {
  ...
  $.ajaxSetup({
    ...
    complete: function (xhr) {
      ...
      if (xhr.status === 200 || xhr.status === 0) { }  // It's OK
...
var $regex = {
  ...
  isUrl: function (val) { return this._Url.test(val) },
  isMail: function (val) { return this._Mail.test(val) },
  isNumber: function (val) { return this._Number.test(val) },
  isDecimal: function (val) { return this._Decimal.test(val) },
  isMobile: function (val) { return this._Mobile.test(val) },
  isTel: function (val) { return this._Tel.test(val) || this._Mobile.test(val) },
  isValidText: function (val) { return this._Text.test(val) },
