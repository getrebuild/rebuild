          ...
          <div className="mb-1">
            ...
            {this.state.enableEquation !== true ? null :
              <div className="mb-3 equation-state">
                <input className={'form-control form-control-sm' + (this.state.equationError ? ' is-invalid' : '')} title={(this.state.equationError ? '高级表达式有误' : '')} value={(this.state.equation || '').toUpperCase()} placeholder={this.state.equationDef || ''} data-id="equation" onChange={this.handleChange} onBlur={(e) => this.checkEquation(e)} />
