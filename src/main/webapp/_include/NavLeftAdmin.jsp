		...
		<div class="left-sidebar-scroll">
			<div class="left-sidebar-content">
				<ul class="sidebar-elements">
					...
					<li class="<%="user-list".equals(activeNav) ? "active" : ""%>" id="nav_user-list"><a href="${baseUrl}/admin/user/user-list.htm"><i class="icon zmdi zmdi-account"></i><span>用户管理</span></a></li>
