		...
		<div class="left-sidebar-scroll rb-scroller">
			<div class="left-sidebar-content">
				<ul class="sidebar-elements">
					...
					<li class="divider">项目</li>
					<li class="${param['activeNav'] == 'projects' ? 'active' : ''}"><a href="${baseUrl}/admin/project/manager"><i class="icon zmdi zmdi-shape"></i><span>项目管理</span></a></li>
