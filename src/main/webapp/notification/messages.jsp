...
let load_list = function(type, page) {
	...
	$.get(rb.baseUrl + '/notification/messages?type=' + type + '&page=' + page, function(res) {
		...
		if (page == 1 && _data.length == 0) {
			$('<div class="list-nodata"><span class="zmdi zmdi-notifications"></span><p>暂无通知</p></div>').appendTo('.notification-list')
			$('.pages').addClass('hide')
		} else {
