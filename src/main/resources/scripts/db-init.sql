...
create table if not exists `robot_trigger_config` (
  ...
  `ACTION_CONTENT`     text(21845) comment '预定义的触发操作类型 (JSON Map)',
...
create table if not exists `robot_approval_config` (
  ...
  `IS_DISABLED`        char(1) default 'F' comment '是否禁用',
  `APPROVAL_ID`        char(20) comment '审核流程',
  `APPROVAL_STATE`     smallint(6) default '草稿' comment '审核状态',
  `APPROVAL_STEP_NODE` varchar(200) comment '审核步骤',
  `MODIFIED_ON`        timestamp not null default current_timestamp comment '修改时间',
  `MODIFIED_BY`        char(20) not null comment '修改人',
  `CREATED_BY`         char(20) not null comment '创建人',
  `CREATED_ON`         timestamp not null default current_timestamp comment '创建时间',
...
create table if not exists `rebuild_api_request` (
  ...
  `REQUEST_BODY`       text(21845) comment '请求数据',
  `RESPONSE_BODY`      text(21845) not null comment '响应数据',
...
create table if not exists `feeds` (
  ...
  `CONTENT`            text(21845) not null comment '内容',
  `CONTENT_MORE`       text(21845) comment '扩展内容 (JSON Map)',
...
create table if not exists `project_task` (
  ...
  `DESCRIPTION`        text(21845) comment '备注',
  `ATTACHMENTS`        varchar(700) comment '附件',
...
create table if not exists `project_task_comment` (
  ...
  `CONTENT`            text(21845) not null comment '评论内容',
  `ATTACHMENTS`        varchar(700) comment '附件',
  `MODIFIED_ON`        timestamp not null default current_timestamp comment '修改时间',
  `MODIFIED_BY`        char(20) not null comment '修改人',
  `CREATED_BY`         char(20) not null comment '创建人',
